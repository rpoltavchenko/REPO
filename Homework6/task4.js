...
const firstEl = list.children[0].innerHTML;
const lastEl = list.children[4].innerHTML;
const secondEl = list.children[1].innerHTML;
const forthEl = list.children[3].innerHTML;
const thirdEl = list.children[2].innerHTML;
